...
public class SocialNetworkTest {
    ...
    public void testGuessFollowsGraphEmpty() {
    	 ...
    	 Tweet tweet3 = new Tweet(3, "mamma", "is it reasonable to @bbbttt talk about rivest so much?@alyssa?", d1);
    	 Tweet tweet4 = new Tweet(4, "bbbttt", "rivest @bbbttttalk in 30 minutes #hype@bbItdiddle", d2);
    ...
    public void testInfluencersEmpty() {
	 ...
	 Tweet tweet3 = new Tweet(3, "mamma", "is it reasonable to @bbbttt talk about rivest so much?@alyssa?", d1);
	 Tweet tweet4 = new Tweet(4, "bbbttt", "rivest @bbbttttalk in 30 minutes #hype@bbItdiddle", d2);
      Map<String, Set<String>> followsGraph1 = SocialNetwork.guessFollowsGraph(Arrays.asList(tweet1,tweet2,tweet3,tweet4));
